...
playbtn.addEventListener("click", function () {
  ...
  userrock.classList.remove("ripple");

  userpaper.classList.add("hidden");
  userpaper.classList.remove("ripple");

  userscissor.classList.add("hidden");
  userscissor.classList.remove("ripple");

  pcrock.classList.add("hidden");
  pcrock.classList.remove("ripple");

  pcpaper.classList.add("hidden");
  pcpaper.classList.remove("ripple");

  pcscissor.classList.add("hidden");
  pcscissor.classList.remove("ripple");
});
...
rock.addEventListener("click", function () {
  ...
  if (pc === "rock") {
    ...
    pcpaper.classList.add("ripple");
    lose();
    pcScore++;
    changePcScore(pcScore);
  } else {
    pcscissor.classList.remove("hidden");
    userrock.classList.add("ripple");
    win();
    userScore++;
...
paper.addEventListener("click", function () {
  ...
  if (pc === "paper") {
    ...
    pcscissor.classList.remove("hidden");
    pcscissor.classList.add("ripple");
    lose();
    pcScore++;
    changePcScore(pcScore);
  } else {
    win();
    userpaper.classList.add("ripple");
    pcrock.classList.remove("hidden");
    userScore++;
    changeUserScore(userScore);
  }
...
scissor.addEventListener("click", function () {
  ...
  if (pc === "scissors") {
    ...
    changePcScore(pcScore);
    pcrock.classList.remove("hidden");
    pcrock.classList.add("ripple");
  } else {
    win();
    userScore++;
    changeUserScore(userScore);
    pcpaper.classList.remove("hidden");
    userscissor.classList.add("ripple");
  }
});
